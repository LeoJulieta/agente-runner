...
## 📁 ARCHIVO 4: labs/README.md (versión post-1.1, ~164 líneas)
...
## 📁 ARCHIVO 5: .github/workflows/lab_run.yml (27 líneas)

```yaml
name: Lab Run - Ejecutar Hipótesis

on:
  workflow_dispatch:
    inputs:
      hypothesis_id:
        description: "ID de la hipótesis (ej: H001)"
        required: true
        type: string
...
jobs:
  run:
    ...
    steps:
      ...
      - name: Ejecutar hipótesis
        run: python labs/lab_engine.py --hypothesis ${{ inputs.hypothesis_id }}
```
